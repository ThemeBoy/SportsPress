...
* Fix - Tournaments scrambling and auto-winner bug.
...
= 2.6.9 =
* Feature - Enable scheduled events in tournament bracket without teams or date selected.
...
* Tweak - Use higher resolution logos in tournament bracket.
* Tweak - Ability to increase tournament rounds.
...
* Fix - Display accurate player numbers in timeline.
* Fix - Remove duplicate password form on staff directory.
...
= 2.6.6 =
* Fix - Results being reversed in scoreboard when reverse team option is enabled.
...
* Tweak - Apply custom order to jobs in staff directories.
...
= 2.2.7 =
* Feature - Facebook module for displaying each team's facebook page as widget.
...
* Feature - Add option to filter staff by current or past team in staff directories.
...
* Feature - Add heading option to tournament brackets.
* Tweak - Allow selection of directories without teams.
* Tweak - Increase league table default width to 1000 pixels.
...
* Fix - Event times not being saved in tournament bracket.
* Fix - Tournament bracket styling when home and away teams are reversed.
* Fix - Competition, season, and jobs not saving in directories.
...
* Tweak - Reorder staff list columns to display name first.
* Tweak - Automatically align home and away columns in event lists.
* Fix - League menu logo appearing smaller.
...
= 2.0.12 =
* Fix - Bracket displaying tournament name when only one team is selected for an event.
* Fix - Event scoreboard shortcode modal box in editor.
...
* Tweak - Remove redundant staff settings.
* Fix - Display staff contact info template in layout designer.
* Fix - Error when admin color scheme is not 3 or 6 characters.

= 2.0.9 =
* Feature - Display admin notice when user is not allowed to edit an item.
* Tweak - Rename tournament meta box to brackets.
* Fix - Team access module dropping other team when editing events.
...
= 1.9.18 =
* Feature - Add ability to hide events in tournament bracket.

= 1.9.17 =
* Feature - Add branding options to hide welcome links.
* Tweak - Allow access limited users to edit posts with no team set.
* Fix - Remove redundant positions meta box from player list admin.
