...
class SportsPress_Google_Maps {
	...
	public function __construct() {
		...
		// Hooks
		add_action( 'sp_venue_show_google_maps', array( $this, 'show_venue_google_maps' ), 10, 5 );
	...
	private function define_constants() {
		if ( !defined( 'SP_GOOGLE_MAPS_VERSION' ) )
			define( 'SP_GOOGLE_MAPS_VERSION', '2.7.0' );
	 ...
	 * @return mix
	 */
	public function show_venue_google_maps( $latitude, $longitude, $address, $zoom, $maptype ) { ?>
