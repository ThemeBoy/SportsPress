<?php
/**
 * Player exporter - export players from SportsPress.
 *
 * @author 		ThemeBoy
 * @category 	Admin
...
<div class="wrap">
	...
	<form method="post" id="sp_player_export_form" action="">
		<ul id="players-filters" class="export-filters" style="display: block;">
			<li>
			...
			<?php do_action('sportspress_players_filters'); ?>
