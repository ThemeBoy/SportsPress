	...
	*/
	private function define_constants() {
		if ( !defined( 'SP_MULTISITE_VERSION' ) )
			define( 'SP_MULTISITE_VERSION', '1.0' );
	...
	private function includes() {
		//include_once( 'includes/sp-multisite-functions.php' );
	...
	public function check_version() {
		if ( ! defined( 'IFRAME_REQUEST' ) && get_option( 'sportspress_sponsors_version' ) != SP_MULTISITE_VERSION ) {
			$this->install();
		}
	}
	...
	public function register_importer() {
		register_importer( 'sportspress_sponsor_csv', __( 'SportsPress Multisite (CSV)', 'sportspress' ), __( 'Import <strong>sponsors</strong> from a csv file.', 'sportspress'), array( $this, 'sponsors_importer' ) );
	}
	...
	public function add_styles( $styles = array() ) {
		$styles['sportspress-sponsors'] = array(
			'src'     => str_replace( array( 'http:', 'https:' ), '', SP_MULTISITE_URL ) . 'css/sportspress-sponsors.css',
			'deps'    => 'sportspress-general',
			'version' => SP_MULTISITE_VERSION,
			'media'   => 'all'
		);
		return $styles;
	}
	...
	public function load_scripts() {
		wp_enqueue_script( 'sportspress-sponsors', SP_MULTISITE_URL .'js/sportspress-sponsors.js', array( 'jquery' ), time(), true );
	}
	...
	public function install() {
		...
		// Update version
		update_option( 'sportspress_sponsors_version', SP_MULTISITE_VERSION );
	...
	public static function admin_enqueue_scripts() {
		wp_enqueue_style( 'sportspress-sponsors-admin', SP_MULTISITE_URL . 'css/admin.css', array( 'sportspress-admin-menu-styles' ), time() );
	}
